package com.example.blogs.email;
...
public class EmailService {
    ...
    private String gmail = "aliyevmurad854@gmail.com";

    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT, GsonFactory jsonFactory)
            throws IOException {
        // Load client secrets.
        InputStream in = EmailService.class.getResourceAsStream("/client_secret_282128466205-2ui6mi7b559kp5r0ge425mhdoar91j6t.apps.googleusercontent.com.json");
    ...
    public String sendTo(String to) throws GeneralSecurityException, IOException, MessagingException {
